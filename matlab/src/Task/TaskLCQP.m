classdef TaskLCQP < ITask
    ...
    methods
        function init(obj,positionList,radiusList,startConfig,endGoal)
            ...
            obj.goal = endGoal;
            obj.controller = ControllerLCQP(obj.robotModel,obstacleCell,obj.goal);
        ...
        function run(obj)
            ...
            t = 0;
            obj.robotModel.updateStatus(obj.start);
            obj.controller.q = obj.start;
